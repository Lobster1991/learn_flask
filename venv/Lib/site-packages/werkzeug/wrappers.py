...
def _run_wsgi_app(*args):
    """This function replaces itself to ensure that the tests module is not
...
class BaseRequest(object):
    ...
    def from_values(cls, *args, **kwargs):
        ...
        :class:`~werkzeug.tests.EnvironBuilder`.

        .. versionchanged:: 0.5
           This method now accepts the same arguments as
           :class:`~werkzeug.tests.EnvironBuilder`.  Because of this the
