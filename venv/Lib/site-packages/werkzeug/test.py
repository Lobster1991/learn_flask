...
def File(fd, filename=None, mimetype=None):
    ...
    warn(DeprecationWarning('werkzeug.tests.File is deprecated, use the '
...
class _TestCookieResponse(object):
    ...
    adapter for our tests responses to make them available for cookielib.
    """
...
class Client(object):
    ...
    def delete_cookie(self, server_name, key, path='/', domain=None):
        """Deletes a cookie in the tests client."""
    ...
    def resolve_redirect(self, response, new_location, environ, buffered=False):
        ...
        # since the tests client must not be shared anyways.
