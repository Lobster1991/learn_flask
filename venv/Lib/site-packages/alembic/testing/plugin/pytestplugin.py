...
def pytest_collection_modifyitems(session, config, items):
    ...
    # expand them out into per-database tests cases.
    ...
    # seems like the functions attached to a tests class aren't sorted already?
...
def pytest_runtest_teardown(item):
    ...
    # of the tests reporting failures correctly (you get a bunch of
    # py.tests assertion stuff instead)
    test_teardown(item)
