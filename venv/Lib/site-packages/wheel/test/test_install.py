...
#   hello/hello.py
#   hello/__init__.py
#   tests-1.0.data/data/hello.dat
#   tests-1.0.data/headers/hello.dat
#   tests-1.0.data/scripts/hello.sh
#   tests-1.0.dist-info/WHEEL
#   tests-1.0.dist-info/METADATA
#   tests-1.0.dist-info/RECORD
# The root is PLATLIB
...
TESTWHEEL = os.path.join(THISDIR, 'tests-1.0-py2.py3-none-win32.whl')
...
def test_install():
    ...
    try:
        ...
        assert check(locs['platlib'], 'tests-1.0.dist-info', 'RECORD')
    finally:
